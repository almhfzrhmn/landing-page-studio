      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="flex flex-col">
          <GlassCard className="flex-grow">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-xs text-white/40 font-poppins uppercase tracking-wider mb-1">
                    Visit Us
                  </h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-sm text-white/80 font-poppins hover:text-[#b58709] transition-colors"
                  >
          ...
          <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent h-48 mt-6 flex flex-col items-center justify-center gap-2">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d38254.94414140086!2d98.50682224066061!3d3.587511848312747!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zM8KwMzYnMzguNyJOIDk4wrAzMCc1My4wIkU!5e0!3m2!1sen!2sid!4v1782056299490!5m2!1sen!2sid"
              loading="lazy"
              allowFullScreen
          ...
          <GlassCard className="h-full">
            ...
            >
              <div>
                <label
                  htmlFor="name"
                  className="text-xs text-white/50 font-poppins uppercase tracking-wider mb-2 block"
                >
                  Your Name
                </label>
                <input
